$(document).ready(function() {;
  ...
  function applyTheme(theme) {
    if (theme === "dark") {
      ...
      $(".themeToggle_button").css("background-color", "#3d3d3d");
      ...
      $(".button").each(function() {
        $(this).css("background-color", "#3d3d3d");
        $(this).css("box-shadow", "2px 2px 15px 5px rgba(0, 0, 0, 0.25)");
      });
      ...
      $(".themeToggle_button").css("background-color", "white");
      ...
      $(".button").each(function() {
        $(this).css("background-color", "white");
        $(this).css("box-shadow", "2px 2px 15px 5px rgba(201, 201, 201, 0.25)");
      });
